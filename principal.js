...
var lupaIcon = new LeafIcon({iconUrl: '/img/pin!.png'}),
    ...
    // Marcadores
    // Studio WiDi
    L.marker([-20.82150, -49.40519], {icon: secadorIcon}).bindPopup("<b>Studio WiDi</b><br/>Clique aqui<br> <a href='tel:173237-6117'><i class='fas fa-phone-square-alt phone__modify'></i>  </a><a href='https://whats.link/studiowidi'><i class='fab fa-whatsapp-square whatsapp__modify'></i></a><br><a target='blank' rel='external' href='https://forms.gle/95ryVaQhXHbuc3AY9'><i class='fas fa-star avaliar__modify'>Avaliar</i></a>").addTo(map);
    // Ticos Burguer
    ...
    // Canossa Tatoo
    L.marker([-20.84768, -49.34314], {icon: canossaIcon}).bindPopup("<b>Canossa Tatoo</b><br/>Apenas com agendamento previo!<br>Clique aqui<br/> <a href='https://whats.link/canossatatoo'><i class='fab fa-whatsapp-square whatsapp__modify'></i></a><br>").addTo(map);
